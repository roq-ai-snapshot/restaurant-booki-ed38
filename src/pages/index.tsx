  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Restaurant Booking Engine, transform your dining experience. Reserve tables effortlessly, while enabling seamless management of reservations and menus for restaurant staff."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Restaurant Booking Engine, transform your dining experience. Reserve tables effortlessly, while enabling seamless management of reservations and menus for restaurant staff.`}
            </Text>
            <Box
