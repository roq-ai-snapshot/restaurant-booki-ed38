...
function ReservationEditPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ReservationInterface>(
    ...
    () => getReservationById(authorizedFetcher, id),
  );
  ...
  const handleSubmit = async (values: ReservationInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateReservationById(authorizedFetcher, id, values);
      mutate(updated);
      resetForm();
      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<UserInterface>
            ...
            fetcher={() => getUsers(authorizedFetcher)}
            labelField={'email'}
          />
          <AsyncSelect<RestaurantInterface>
            ...
            fetcher={() => getRestaurants(authorizedFetcher)}
            labelField={'name'}
          />
